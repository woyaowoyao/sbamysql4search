...
public class MentorSkillResource {
    ...
    /**
     * {@code SEARCH  /_search/mentor-skills?query=:query} : search for the mentorSkill corresponding
     * to the query.
     *
     * @param query the query of the mentorSkill search.
     * @return the result of the search.
     */
    @GetMapping("/_search/mentor-skills")
    public List<MentorSkill> searchMentorSkills(@RequestParam String query) {
        log.debug("REST request to search MentorSkills for query {}", query);
        return mentorSkillService.search(query);
    }
}
